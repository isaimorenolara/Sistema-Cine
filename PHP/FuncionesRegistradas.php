  ...
  while($registro = $res->fetch_assoc())
	{
		...
		$html.="<tr>
                <td class='text-center'><img class='rounded img-fluid' src='data:$tipo;base64,$imagen' width='250' height='270' alt='".$registro['Nombre']."'></td>
    ...
    <body>
      ...
      <main role="main">
        <div class="container marketing">
          <h2>Lista de funciones en la Base de Datos</h2>
          <br>
          <?= $html?>
