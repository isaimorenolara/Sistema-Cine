<?php
  ...
  if ($mysqli->connect_errno) 
  {
	...
	$res = $mysqli->query("select * from usuarios") or 
  ...
  while($registro = $res->fetch_assoc())
	{
		...
		$html.="<tr>
                ...
                <td class='text-center'><button type='button' class='btn btn-danger' onclick='location.href=\"BorrarUsuario.php?Id_Usuario=".$registro['Id_Usuario']."\"'>Eliminar</button></td>
            </tr>";
		$cont++;
		$contador++;
	}
