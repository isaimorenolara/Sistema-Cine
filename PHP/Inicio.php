      ...
      <div class="container marketing">
        <div class="row">
          <div class="col-lg-4">
            ...
            <h5>Clasificación</h5><p>S/C</p>
            <h5>Género</h5><p></p>Acción, Aventura, Fantasía</p>
        ...
        <div class="detalles card text-center" id="detalle1" style="display: none;">
          ...
          <div class="card-body">
            ...
            <h6>Clasificación</h6><p>S/C</p>
            <h6>Género</h6><p></p>Acción, Aventura, Fantasía</p>
            <h6>Director</h6><p></p>Taika Waititi</p>
            <h6>Actores</h6><p></p>Chris Hemsworth, Natalie Portman, Christian Bale</p>
            <h6>País</h6><p></p>Estados Unidos</p>
        ...
        <div class="detalles card text-center" id="detalle2"  style="display: none;">
          ...
          <div class="card-body">
            ...
            <h6>Clasificación</h6><p>S/C</p>
            <h6>Género</h6><p></p>Animación</p>
            <h6>Director</h6><p></p>Kyle Balda, Brad Ableson</p>
            <h6>Actores</h6><p></p>Steve Carell, Pierre Coffin, Taraji P. Henson, Jean-Claude Van Damme, Michelle Yeoh, Dolph Lundgren</p>
            <h6>País</h6><p></p>Estados Unidos</p>
            <a href="#" class="btn btn-danger rounded-pill">Comprar boletos  &raquo;</a>
          </div>
          <div class="card-footer text-muted">
        ...
        <div class="detalles card text-center" id="detalle3" style="display: none;">
          ...
          <div class="card-body">
            ...
            <h6>Clasificación</h6><p>A</p>
            <h6>Género</h6><p></p>Animación</p>
            <h6>Director</h6><p></p>Angus MacLane</p>
            <h6>Actores</h6><p></p>Chris Evans, Uzo Aduba, James Brolin, Mary McDonald-Lewis, Keke Palmer, Efren Ramirez, Peter Sohn</p>
            <h6>País</h6><p></p>Estados Unidos</p>
            <a href="#" class="btn btn-danger rounded-pill">Comprar boletos  &raquo;</a>
          </div>
          <div class="card-footer text-muted">
